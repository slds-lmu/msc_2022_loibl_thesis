...
\begin{itemize}
    ...
    \item $\textbf{x}_6$ uniformly distributed on 8 factor levels (128 possible split sets) %stirling number of second kind    
    \item $y \sim N(0,1)$
    \item sample size $n = 1000$
    \item 1000 simulation runs
\end{itemize}
