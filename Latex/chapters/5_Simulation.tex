...
As in the previous scenario the MBTs are fitted as standalone models and surrogates on lm predictions on a dataset with sample size $ n = 2000$ using the pruning parameter settings $alpha = 0.001$ and $impr = 0.1$. The simulation is repeated $250$ times.
...
In the appendix in the figures \ref{fig:lasso_standalone_r2_test} and \ref{fig:lasso_standalone_r2_test_slim} there is a more detailed presentation of the individual results. It is particularly noticeable that, as with the basic scenario linear smooth, all SLIM MBTs and GUIDE generate some strongly asymmetrical trees, which then have a considerable poorer performance.
...
\begin{enumerate}
    ...
    \item linear regression with bspline transformations of the features (bsplines)
    \item GAM 
\end{enumerate}
...
\hline
standalone & basic lm & 17.48 & 13 & 28 & 4.76 & 4 & 6 & 0.4525 & 6.5763 & 0.1578\\
standalone & penalized\_poly & 4.36 & 3 & 7 & 2.16 & 2 & 3 & 0.3605 & 8.1847 & 0.8960\\
standalone & bsplines & 2.04 & 2 & 3 & 1.00 & 1 & 1 & 0.0000 &  & \\
standalone & gam & 2.04 & 2 & 3 & 1.00 & 1 & 1 & 0.0000 &  & \\
\hline
xgboost & basic\_lm & 19.82 & 2 & 33 & 4.76 & 1 & 6 & 0.6125 & 6.8671 & 0.1438\\
xgboost & penalized\_poly & 3.58 & 2 & 7 & 2.08 & 1 & 4 & 0.3880 & 8.5499 & 1.1147\\
...
\hline
standalone & basic lm & 0.9243 & 0.0062 & 0.9113 & 0.0054 & 53.9438\\
...
\hline
xgboost & basic lm & 0.9200 & 0.0228 & 0.9023 & 0.0190 & 55.7771\\
