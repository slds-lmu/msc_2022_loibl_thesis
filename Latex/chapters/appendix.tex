...
\begin{figure}[!htb]
    \centering
    \includegraphics[width = 14cm]{Figures/simulations/batchtools/selection_bias_slim/independence_10.png}\\
    \includegraphics[width = 14cm]{Figures/simulations/batchtools/selection_bias_slim/independence_25.png}\\
    \includegraphics[width = 14cm]{Figures/simulations/batchtools/selection_bias_slim/independence_50.png}\\
    \includegraphics[width = 14cm]{Figures/simulations/batchtools/selection_bias_slim/independence_100.png}\\
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
