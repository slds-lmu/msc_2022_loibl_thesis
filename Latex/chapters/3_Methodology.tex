...
No implementation of SLIM was found, which is why an implementation in R was carried out as part of this work. The source code for this can be found at \url{https://github.com/slds-lmu/msc_2022_loibl_thesis}. 
...
MOB and CTree are implemented in the R package $\mathtt{partykit}$ \citep{.2015}
