...
categorical_linear_big = generate_data_sim("categorical_linear", n = 3000, rep = 200, maxdepth = 5, minsize = 50, alpha = 1, pruning = "none", approximate = FALSE)

linear_mixed_big = generate_data_sim(scenario = "linear_mixed", n = 6000, rep = 200, maxdepth = 5, 
