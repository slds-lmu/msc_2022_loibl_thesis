# build trees based on very simple simulation example
...
y_interaction = 1 + x1 + x2 + ifelse(x1<0, 3*x2,0) + eps
...
plot_scores(scores_linear, x = cbind(x1,x2), name = "correctly_specified_minus1_1")
plot_scores(scores_interaction, x = cbind(x1,x2), name = "misspecified_minus1_1")
...
independence_test(scores_interaction ~ x1 + x2)                                     
